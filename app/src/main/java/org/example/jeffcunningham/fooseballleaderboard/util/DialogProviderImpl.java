        ...
        dialog.getButton(AlertDialog.BUTTON_POSITIVE)
            .setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (DialogProviderImpl.this
                        .validateEditText(player1Name, player1TextInputLayout) &&
                        DialogProviderImpl.this
                            .validateEditText(player2Name, player2TextInputLayout) &&
